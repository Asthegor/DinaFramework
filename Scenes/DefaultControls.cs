...
namespace DinaFramework.Scenes
{
    ...
    public static class DefaultControls
    {
        ...
        (
            ...
            new KeyboardKey(Keys.RightShift, alias: "Pause"),
            new KeyboardKey(Keys.Enter, alias: "Activate"),
            new KeyboardKey(Keys.Escape, alias: "Cancel")
        );
        ...
        (
            ...
            PlayerIndex.One,
            new GamepadButton(Buttons.LeftStick, alias: "up"),
            new GamepadButton(Buttons.LeftStick, alias: "down"),
            new GamepadButton(Buttons.LeftStick, alias: "left"),
            new GamepadButton(Buttons.LeftStick, alias: "right"),
            new GamepadButton(Buttons.Start, alias: "Pause"),
            new GamepadButton(Buttons.A, alias: "Activate"),
            new GamepadButton(Buttons.B, alias: "Cancel")
        );
    }
}
